...
void PinModeAF (int PortPin);


// Interrupt configuration functions
void PinIrqRE(int PortPin);  // Enable rising-edge interrupt
void PinIrqFE(int PortPin);  // Enable falling-edge interrupt
void PinIrqRFE(int PortPin); // Enable both rising and falling-edge interrupt
void PinIrqReStop(int PortPin); // Disable rising-edge interrupt
void PinIrqFeStop(int PortPin); // Disable falling-edge interrupt
void PinIrqFReStop(int PortPin); // Disable both edges
void PinIrqStop(int PortPin);    // Fully disable interrupt for the pin